...
void TEST_CLASS_FOR_Matrix :: TESTING_rectZero (void)
{
	...
	Matrix<int> mat(a,b) ;
	mat.print() ;
	cout << mat.rows() << " " << mat.columns() << endl ;
}
...
void TEST_CLASS_FOR_Matrix :: TESTING_convertToVector(void)
{
	int NUM_ROWS = 1, NUM_COLS = 3 ;
	double **a ;
	a = new double*[NUM_ROWS] ;
	for (int i=0; i<NUM_ROWS; i++)
		a[i] = new double[NUM_COLS] ;
	...
	for (int i=0; i<NUM_ROWS; i++)
		delete[] a[i] ;
	delete[] a ;
	Vector<double> vec = mat1.convertToVector() ;
	vec.print() ;
	...
	for (int i=0; i<NUM_ROWS; i++)
		a[i] = new double[NUM_COLS] ;
	a[0][0] = 1.5 ; a[1][0] = -9.9 ; a[2][0] = 12 ;
	Matrix<double> mat3(a,NUM_ROWS,NUM_COLS) ;
	mat3.print() ;
	for (int i=0; i<NUM_ROWS; i++)
		delete[] a[i] ;
	delete[] a ;
	vec = mat3.convertToVector() ;
	vec.print() ;
...
int main(int argc, char **argv)
{
	...
	cout << "Testing convertToVector() method ..." << endl ;
	test.TESTING_convertToVector() ;
